...
train_dataset = TripletDataset(
    ...
    preprocess_d=args.preprocess_d,
    preprocess_q=args.preprocess_q,
...
if args.model == "ce":
    ...
    model = DenseBiEncoder(args.pretrained, args.normalize_enc)
    ...
    model = SparseBiEncoder(
        args.pretrained, q_alpha=args.q_reg, d_alpha=args.d_reg, T=args.T, normalize_enc=args.normalize_enc
    )
else:
    raise Exception(
