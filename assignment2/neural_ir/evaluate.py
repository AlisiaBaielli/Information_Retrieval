...
parser.add_argument("--queries_path", type=str, default="data/dev_queries.tsv", help="path to  dev queries")
######################################################################
...
#              Start training                                        #
######################################################################
# only evaluate the model, skip the rest
# trainer.train()
# trainer.save_model()
...
with open(metrics_path, "w") as f:
    json.dump(metrics, f)
print(f"Model {args.model.upper()} ({args.pretrained}) evaluated on {args.queries_path}; metrics saved to {metrics_path}.")